...
public interface MemberMessageOrBuilder extends
   ...
   * @return The operator.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.User getOperator();
  /**
   * <code>.User operator = 4;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.UserOrBuilder getOperatorOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.MemberMessage.EffectConfig getEffectConfig();
  /**
   * <code>.MemberMessage.EffectConfig effectConfig = 13;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.MemberMessage.EffectConfigOrBuilder getEffectConfigOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.MemberMessage.EffectConfig getEnterEffectConfig();
  /**
   * <code>.MemberMessage.EffectConfig enterEffectConfig = 15;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.MemberMessage.EffectConfigOrBuilder getEnterEffectConfigOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Image getBackgroundImageV2();
  /**
   * <code>.Image backgroundImageV2 = 17;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ImageOrBuilder getBackgroundImageV2OrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Text getAnchorDisplayText();
  /**
   * <code>.Text anchorDisplayText = 18;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.TextOrBuilder getAnchorDisplayTextOrBuilder();
