...
public interface RoomOrBuilder extends
   ...
   * @return The extra.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.RoomExtra getExtra();
  /**
   * <code>.RoomExtra extra = 10;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.RoomExtraOrBuilder getExtraOrBuilder();
...
java.lang.String defaultValue);
   ...
   * @return The cover.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Image getCover();
  /**
   * <code>.Image cover = 20;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ImageOrBuilder getCoverOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Image getDynamicCover();
  /**
   * <code>.Image dynamicCover = 21;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ImageOrBuilder getDynamicCoverOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Image getDynamicCoverLow();
  /**
   * <code>.Image dynamicCoverLow = 22;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ImageOrBuilder getDynamicCoverLowOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.StreamUrl getStreamUrl();
  /**
   * <code>.StreamUrl streamUrl = 28;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.StreamUrlOrBuilder getStreamUrlOrBuilder();
   ...
   * @return The linkMic.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.LinkMic getLinkMic();
  /**
   * <code>.LinkMic linkMic = 32;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.LinkMicOrBuilder getLinkMicOrBuilder();
   ...
   */
  java.util.List<cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Decoration> 
      getDecoListList();
  /**
   * <code>repeated .Decoration decoList = 34;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Decoration getDecoList(int index);
  /**
   * <code>repeated .Decoration decoList = 34;</code>
   */
   ...
   * <code>repeated .Decoration decoList = 34;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.DecorationOrBuilder> 
      getDecoListOrBuilderList();
  /**
   * <code>repeated .Decoration decoList = 34;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.DecorationOrBuilder getDecoListOrBuilder(
      int index);

  /**
   * <code>repeated .TopFan topFans = 35;</code>
   */
  java.util.List<cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.TopFan> 
      getTopFansList();
  /**
   * <code>repeated .TopFan topFans = 35;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.TopFan getTopFans(int index);
  /**
   * <code>repeated .TopFan topFans = 35;</code>
   */
  int getTopFansCount();
   ...
   * <code>repeated .TopFan topFans = 35;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.TopFanOrBuilder> 
      getTopFansOrBuilderList();
  /**
   * <code>repeated .TopFan topFans = 35;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.TopFanOrBuilder getTopFansOrBuilder(
      int index);
   ...
   * @return The stats.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.RoomStats getStats();
  /**
   * <code>.RoomStats stats = 36;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.RoomStatsOrBuilder getStatsOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Image getFeedRoomLabel();
  /**
   * <code>.Image feedRoomLabel = 42;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ImageOrBuilder getFeedRoomLabelOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.RoomUserAttr getLivingRoomAttrs();
  /**
   * <code>.RoomUserAttr livingRoomAttrs = 44;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.RoomUserAttrOrBuilder getLivingRoomAttrsOrBuilder();
   ...
   * @return The owner.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.User getOwner();
  /**
   * <code>.User owner = 46;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.UserOrBuilder getOwnerOrBuilder();
